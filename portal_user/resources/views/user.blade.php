...
<button @click="openModal = true" class="w-full flex items-center px-4 py-4 bg-slate-700 text-white rounded-lg font-bold text-sm tracking-wider shadow-md">
                ...
                <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-4 bg-amber-500 text-white rounded-lg font-bold text-sm tracking-wider shadow-md">
...
<!-- Main Content -->
        <main class="flex-1 p-4 md:p-6 overflow-y-auto bg-white">
            <div class="mb-4 md:mb-6 border-b border-slate-700 pb-4 md:pb-6">
                <h1 class="text-lg md:text-xl font-black tracking-widest text-amber-400 uppercase">Selamat Datang ke Sistem E-Aduan KSAS</h1>
                <p class="text-xs font-bold text-amber-500 mt-1 uppercase tracking-wider">Sistem E-Aduan Keselamatan KSAS</p>
            </div>
