...
<head>
    ...
    <title>Lupa Kata Laluan | E-Aduan KSAS UPSI</title>
    ...
    <div class="w-72 bg-amber-50 flex flex-col pt-8 border-r border-amber-200 shadow-sm z-10 hidden md:flex">
        ...
        <nav class="flex-1 px-4 space-y-2">
            <div class="flex items-center px-4 py-4 bg-amber-100 text-amber-800 rounded-lg font-bold text-sm tracking-wider border border-amber-200">
                <span class="mr-4 text-lg">🔑</span> RESET KATA LALUAN
            </div>
        </nav>
        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl border border-slate-200 shadow-lg p-8">
                ...
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-xl font-black tracking-widest text-slate-900 uppercase">Lupa Kata Laluan</h1>
                ...
                <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
                    <p class="text-xs text-emerald-700 font-medium">
                        Masukkan alamat email anda dan kami akan menghantar pautan tetapan semula kata laluan.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <!-- Email Address -->
                    <div class="mb-6">
                        <label class="block text-[10px] font-black text-slate-600 uppercase tracking-widest mb-2">Alamat Email</label>
                        <input 
                            type="email" 
                            name="email" 
                            value="{{ old('email') }}"
                            placeholder="contoh@upsi.edu.my"
                    ...
                    <div class="flex items-center justify-between gap-3">
                        <a href="{{ route('login') }}" class="flex-1 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-sm tracking-widest rounded-lg shadow-sm transition-all text-center uppercase">
                            Batal
                        </a>
                        
                        <button type="submit" class="flex-1 py-3 bg-amber-600 hover:bg-amber-700 text-white font-black text-sm tracking-widest rounded-lg shadow-md transition-all uppercase">
                            Hantar Pautan
                        </button>
                    </div>
                </form>
